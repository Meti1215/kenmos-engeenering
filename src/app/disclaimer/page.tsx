    ...
    <main className="relative min-h-screen bg-gray-50">
      ...
      <section className="pt-32 pb-8 md:pb-14 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <div className="inline-flex w-10 h-10 md:w-14 md:h-14 bg-[#D71920]/10 items-center justify-center mx-auto mb-3 md:mb-5">
              <AlertTriangle className="w-5 h-5 md:w-7 md:h-7 text-[#D71920]" />
            </div>
      ...
      <section className="pb-10 md:pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto bg-white border border-gray-100 shadow-lg p-4 md:p-8 space-y-2 md:space-y-4 text-[10px] md:text-base text-gray-700">
